...
public class EstudianteServices {
    ...
    public static Estudiante getEstudiantePorMatricula(int matricula){
        return listaEstudiantes().stream().filter(e -> e.getMatricula() == matricula).findFirst().orElse(null);
    }
